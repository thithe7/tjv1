        ...
        <form role="form-horizontal" action="{!! url('/hotel/room/newallotment') !!}" method="POST" id="formrates2">
            ...
            <div class="nav-tabs-custom" style="width: 900px;">
                <ul class="nav nav-pills">
                    ...
                    <!--                     <li><a href="#price" data-toggle="tab">Contact Person</a></li> -->
                </ul>
                <!-- Tab Detail -->
                        ...
                        <table id="hotelstopsell" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <!--<th><button type='button' data-id="" class='btn btn-flat btn-xs btn-block btn-danger stop_sale'><i class='fa fa-plus'>Save Stop Sell</i></button>
