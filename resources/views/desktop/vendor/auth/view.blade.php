...
<head>
    ...
    <title>TravelJinni | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ URL::asset('theme/admin/plugins/iCheck/square/blue.css') }}">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
          <div class="login-logo">
            <a href="{{ url('/admin') }}"><b>Travel</b>Jinni</a>
        </div><!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Sign in to start your session</p>
            <form action="{{ url('/tjvendor/login') }}" method="post">
